...
import { ChevronDown, ChevronUp, Clock, MoreHorizontal, MoreHorizontalIcon, RefreshCw, Search, Trash, X } from 'lucide-react';
...
const TransactionTable = ({ transactions }) => {
  ...
  const filteredAndSortedTransactions = useMemo(() => {
    ...
    if (recurringFilter === "NON_RECURRING") {
      result = result.filter(
        (transaction) => !transaction.isRecurring
      );
    }
        ...
        <div className="flex flex-col sm:flex-row gap-4">
          ...
          <div className='flex gap-2'>
            ...
            >
              ...
              <SelectContent className="bg-white z-[100] shadow-lg">
              ...
              <TableHeader>
                <TableRow>
                  <TableHead className="w-[50px]">
                    <Checkbox className="border-gray-400 data-[state=checked]:border-black"
                    ...
                    <div className='flex items-center'>
                      ...
                      {sortConfig.field == "date" &&
                        (sortConfig.direction === "asc" ? (
                          <ChevronUp className='m1-1 h-4 w-3' />) : (
                    ...
                    <TableRow key={transaction.id}
                      ...
                      <TableCell className="text-right">
                        <div className="relative inline-block group">
                          ...
                          <div className="absolute right-0 mt-1 hidden w-32 rounded-md border bg-white shadow-md group-hover:block z-50">
